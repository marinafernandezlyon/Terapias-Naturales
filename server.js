...
app.get('/anadir-producto-admin-Alicia', function (req, res) {
	/*ProductModel.find(function (err, products) {
  		console.log(products);*/
		res.render('form_details_products');
	//});
});
...
app.get('/', function (req, res) {
	ProductModel.find(function (err, shop) { // je récupère toute la collection de produits depuis la base de données 
  		/*console.log(shop);*/
		res.render('index-shop', {shopList : shop}); //et je l'affiche dans la page de l'index shop
	});
});
...
app.get('/suprimir-producto-admin-Alicia', function (req, res) {
	ProductModel.find(function (err, shop) { // je récupère toute la collection de produits depuis la base de données 
  		res.render('delete_product_form', {shopList : shop});//et je l'affiche dans la page de delete_product_form
	});
});
